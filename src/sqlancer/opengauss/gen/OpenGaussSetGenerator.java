...
public final class OpenGaussSetGenerator {

    private OpenGaussSetGenerator() {
    }

    private enum ConfigurationOption {
        // https://www.opengauss.org/docs/11/runtime-config-wal.html
        ...
        // archive_command
        // archive_timeout
        // https://www.opengauss.org/docs/11/runtime-config-statistics.html
        ...
        // https://www.opengauss.org/docs/11/runtime-config-autovacuum.html
...
//                (r) -> Randomly.fromOptions(0, 5, 10, 100, 500, 1000000000)),
        ...
        // https://www.opengauss.org/docs/devel/runtime-config-query.html
        ...
        // https://www.opengauss.org/docs/current/runtime-config-query.html#RUNTIME-CONFIG-QUERY-CONSTANTS
        ...
        // https://www.opengauss.org/docs/current/runtime-config-query.html#RUNTIME-CONFIG-QUERY-GEQO
        ...
        // https://www.opengauss.org/docs/current/runtime-config-query.html#RUNTIME-CONFIG-QUERY-OTHER

...
public final class OpenGaussSequenceGenerator {

    private OpenGaussSequenceGenerator() {
    }

    public static SQLQueryAdapter createSequence(OpenGaussGlobalState globalState) {

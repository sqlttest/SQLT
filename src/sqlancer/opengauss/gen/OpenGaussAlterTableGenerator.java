...
public class OpenGaussAlterTableGenerator {

    private OpenGaussTable randomTable;
    private Randomly r;
    private static OpenGaussColumn randomColumn;
    ...
    public OpenGaussAlterTableGenerator(OpenGaussTable randomTable, OpenGaussGlobalState globalState,
    ...
    public static SQLQueryAdapter create(OpenGaussTable randomTable, OpenGaussGlobalState globalState,
            boolean generateOnlyKnown) {
        return new OpenGaussAlterTableGenerator(randomTable, globalState, generateOnlyKnown).generate();
    }
    ...
    public SQLQueryAdapter generate() {
        ...
        for (Action a : action) {
            ...
            case ALTER_COLUMN_TYPE:
                ...
                sb.append(" TYPE ");
                OpenGaussDataType randomType = OpenGaussDataType.getRandomType();
                OpenGaussCommon.appendDataType(randomType, sb, false, generateOnlyKnown, opClasses);
            ...
            case ALTER_COLUMN_SET_DROP_DEFAULT:
                ...
                if (Randomly.getBoolean()) {
                    ...
                    sb.append(OpenGaussVisitor.asString(
                            OpenGaussExpressionGenerator.generateExpression(globalState, randomColumn.getType())));
...
//                break;
            case ADD_TABLE_CONSTRAINT:
                ...
                OpenGaussCommon.addTableConstraint(sb, randomTable, globalState, errors);
    ...
    private static void alterColumn(OpenGaussTable randomTable, StringBuilder sb) {
        sb.append("ALTER ");

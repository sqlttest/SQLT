...
public final class OpenGaussVacuumGenerator {

    private OpenGaussVacuumGenerator() {
    }
    ...
    public static SQLQueryAdapter create(OpenGaussGlobalState globalState) {
        ...
        errors.add("deadlock"); /*
                                 * "FULL" commented out due to https://www.opengauss.org/message-id/CA%2Bu7OA6pL%
    ...
    private static void addTableAndColumns(OpenGaussTable table, StringBuilder sb) {
        sb.append(" ");
        sb.append(table.getName());
        if (Randomly.getBoolean()) {
            sb.append("(");

...
public final class OpenGaussViewGenerator {

    private OpenGaussViewGenerator() {
    }
    ...
    public static SQLQueryAdapter create(OpenGaussGlobalState globalState) {
        ...
        // }
        sb.append(" AS (");
        OpenGaussSelect select = OpenGaussRandomQueryGenerator.createRandomQuery(nrColumns, globalState);
        sb.append(OpenGaussVisitor.asString(select));
        sb.append(")");

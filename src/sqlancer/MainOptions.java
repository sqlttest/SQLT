...
public class MainOptions {
    ...
    @Parameter(names = {
        "--gpt-sqlite3" }, description = "enable gpt-sqlite3")
    private boolean gptSqlite3 = false; 
    ...
    private int nrQueries = 30000; // NOPMD
    ...
    private int nrStatementRetryCount = 100; // NOPMD

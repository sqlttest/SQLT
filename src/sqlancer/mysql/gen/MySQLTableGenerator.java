...
//        //若为VAR的话，重新生成，降低VAR的触发概率
//        while(randomType == MySQLDataType.VAR || Randomly.getBooleanWithSmallProbability()){
//            randomType = MySQLDataType.getRandom(globalState);
//        }
        appendType(randomType);
        sb.append(" ");
        if(randomType == MySQLDataType.JSON){
            return;
        }
//        if(randomType == MySQLDataType.VAR){
//            // 自定义类型
//            return;
//        }
    ...
    private void appendType(MySQLDataType randomType) {
        ...
        case BIT:
            ...
            if (Randomly.getBoolean()) {
                sb.append("(");
                sb.append(Randomly.getNotCachedInteger(1, 64));
                sb.append(")");
            }
            break;
        case DOUBLE:
